...
public class POIReadExcel {
    ...
    private static String getBorderStyle(HSSFPalette palette, int b, short s, short t) {
        ...
        if (s == 0) return bordesr[b] + borderStyles[s] + "#000 1px;";
        String borderColorStr = convertToStardColor(palette.getColor(t));
        borderColorStr = borderColorStr == null || borderColorStr.length() < 1 ? "#000" : borderColorStr;
    ...
    private static String getBorderStyle(int b, short s, XSSFColor xc) {
        ...
        if (xc != null && !"".equals(xc)) {
            ...
            borderColorStr = borderColorStr == null || borderColorStr.length() < 1 ? "#000" : borderColorStr.substring(2);
            return bordesr[b] + borderStyles[s] + borderColorStr + " 1px;";
        }
